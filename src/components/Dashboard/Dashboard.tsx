...
import { increaseCount, decreaseCount } from '../../store/counter';
...
const mapStateToProps = ({ counter, boards, auth }: AppState) => {
    return {
...
const mapDispatchToProps = (dispatch: any) => {
    return {
        onIncreace: () => dispatch(increaseCount()),
        onDecreace: () => dispatch(decreaseCount()),
